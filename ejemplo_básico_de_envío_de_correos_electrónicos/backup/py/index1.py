...
def programar_envio_correo(destinatario, asunto, cuerpo, adjunto=None, hora_programada=None):
    if not hora_programada:
        enviar_correo(destinatario, asunto, cuerpo, adjunto)
        return

    schedule.every().day.at(hora_programada).do(enviar_correo, destinatario, asunto, cuerpo, adjunto)
...
adjunto = 'archivo.pdf'
hora_programada = '16:10'

programar_envio_correo(destinatario, asunto, cuerpo, adjunto, hora_programada)
