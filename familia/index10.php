    ...
    <script>
        $(document).ready(function() {
            ...
            function actualizarContenido() {
                $.ajax({
                    url: "uni12.php", // Archivo PHP que maneja la lógica de actualización
                    type: "GET",
                    success: function(data) {
                        $("#contenido_dinamico").html(data); // Actualizar el contenido dinámico
                    }
            ...
            $("#link_actualizar").click(function(event) {
                ...
                cargarContenidoPagina("uni12.php"); // Cargar el contenido de actualizar_tareas.php
            });

            // Manejar clic en el enlace "Mostrar Otro Archivo"
            $("#link_otro_archivo").click(function(event) {
                event.preventDefault(); // Prevenir el comportamiento predeterminado del enlace
                cargarContenidoPagina("index11.php"); // Cargar otro archivo
            });

            // Cargar el contenido de actualizar_tareas.php por defecto
            cargarContenidoPagina("uni12.php");
        });
    </script>
</body>
</html>
